      ...
      *> Users may freely modify and redistribute this program.ddf
       ...
       77  TIME-DISPLAY         PIC Z,ZZZ,ZZ9.99.
       77  IND                  PIC 9(9).
       01  TEXT1                pic x(9).
       ...
       MAIN-LOGIC.
           ...
           MOVE TOTAL-TIME TO TIME-DISPLAY.
           DISPLAY "Total Time: " TIME-DISPLAY
           GOBACK
           .
       ...
       LOAD-FILE1-TEST.
           ...
           MOVE TIME-DIFF TO TIME-DISPLAY
           DISPLAY "WRITE:      " TIME-DISPLAY
           .
